...
/**
 * The contract is technically a contract element, but it represents
 * the whole contract by containing all other elements within it.
 *
 */
public class Contract implements IContractElement {
    ...
    /**
     * Calls upon all elements of the contract to accept the visitor 
     * provided (thus applying that step of the algorithm to the
     * contract).
     */
    @Override
